...
#(takes two from the list above) Take a random sample of 2 items from the vector "ships": 
sample(ships, 2)
...
View(mtcars) #view cars in excel type sheet
...
# Notice how these two vectors differ (practicing the length() function): 
